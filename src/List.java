 ...
 * angeordnete Objekte vom Typ Type. Auf hoechstens ein Listenobjekt,
...
public class List<Type> {
    ...
    private class ListNode {
         ...
         */
        private ListNode(Type pContent) {
         ...
         */
        public void setContentObject(Type pContent) {
            contentObject = pContent;
        }
     ...
     * geschieht nichts.
     */
    public void setContent(Type pContent) {
     ...
     */
    public void insert(Type pContent) {
     ...
     */
    public void append(Type pContent) {
